...
export default class App extends Component<Props, State> {
    ...
    constructor(props) {
        super(props)
        this.state = {
            appId: '4e0370075e574ef0952c98118c284498',
            channelName: 'yourChannel',
            token: '0064e0370075e574ef0952c98118c284498IAA3Kmx53oSs2NreuzDYNU8uqxrGP7YYlGee9WwpyfgT9rX6bWoAAAAAEACOhaHHrSHwYgEAAQCsIfBi',
            joinSucceed: false,
            peerIds: [],
        }
...
startCall = async () => {
  await this._engine?.joinChannel(this.state.token, this.state.channelName, null, Math.floor(Math.random() * 6) + 1)
}
